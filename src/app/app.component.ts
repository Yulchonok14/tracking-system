...
export class AppComponent implements OnInit {
  ...
  constructor(private _projectService: ProjectService, private _reportService: ReportService,
    ...
    this.weekObj = {
      '2018-01-01': {hour: 0, reportId: ''},
      '2018-01-02': {hour: 0, reportId: ''},
      '2018-01-03': {hour: 0, reportId: ''},
      '2018-01-04': {hour: 0, reportId: ''},
      '2018-01-05': {hour: 0, reportId: ''},
      '2018-01-06': {hour: 0, reportId: ''},
      '2018-01-07': {hour: 0, reportId: ''}
    };
  ...
  onTimeChange(target: any, reportName: string) {
    ...
    if (reportId === '') {
      ...
      this._reportService.updateReport(reportId, date,
        this.curUser, reportName, target.value, this.curProjId);
    }
  }
  ...
  onDatePeriodChanged(periodObj: any) {
    ...
    //const obj = { ...weekArr };
    console.log(this.setDate(this.formWeekObj(weekArr)));
  }
  ...
  formWeekObj(weekArr) {
    ...
    for (let i = 0; i < weekArr.length; i++) {
      weekObj[weekArr[i]] = {hour: 0, reportId: ''};
    }
